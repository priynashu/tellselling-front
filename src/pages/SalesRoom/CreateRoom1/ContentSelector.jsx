 ...
 */
    ...
    render() {
        // console.log("content data",this.props.InfoData);
        if(this.state.previewBtn===true){
            let data=[]
             axios.get(backend_url+`salesroom/${this.state.link}`).then((res)=>{
        ...
        const handlePreviewClick=async()=>{
            ...
            if(this.state.previewBtn===false){
                window.open(backend_url+`salesroom-basic/:${this.state.link}`,"","width=1000,height=1000")
            }
