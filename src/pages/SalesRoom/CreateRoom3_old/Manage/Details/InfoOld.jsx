...
class Info extends Component {
    constructor(props) {
        ...
        this.state = {
            alignment: 'left',
            dateValue: new Date(),
            selected_thumbnail: this.props.Data.thumbnail,
            ...
            <>
                            ...
                            <Form>
                                <Row className='mt-3'>
                                    <Col sm={12}>
                                        ...
                                        <InputGroup className="mb-3">
                                            <Form.Control placeholder="Sales Demo Webminar" onChange={HandleTitle} value={this.props.Data.name} className={styles.event_form} />
                                ...
                                <Row className="mb-4">
                                    <Col sm={12}>
                                        ...
                                        <Form.Control value={this.props.Data.link} placeholder="Stream ID e.g. XXXXXXXX" onChange={HandleLink}/>
                                    </Col>
                                </Row>
                            </Form>
                        </Col>
                ...
                <Container >
                    <Row className={styles.row2}>
                        <Col>
                            <Schedule SetEventType={SetEventType} Type={this.state.event_type} Dates={this.props.Data.events} SetEventDates={SetEventDates} />
                            <br />
                            <br />
                            <Row>
                                <br />
