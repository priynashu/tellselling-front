  ...
  GetDataIfEdit(){
    ...
    if(query.length!=0){
      ...
      .then((res)=>{
        ...
        this.setState({info: { name: data.title, thumbnail: data.thumbnail, description: data.description, tags: data.tags, link: data.link, platform: data.platform, stream_id: data.stream_id, events:data.events,dateTime:data.dateTime }})
