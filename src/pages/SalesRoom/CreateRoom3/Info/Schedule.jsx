    ...
    render() {
        ...
        const MultipleEvent = () => {
            ...
            const SubmitNew = (e) => {
                ...
                this.props.setEventDate(d.toLocaleString())
                // console.log("date obj",obj);
                this.props.setFullDate(d)
                    ...
                    <Modal
                        ...
                        <Box sx={style} style={{ border: 'none' }}>
                            ...
                            <Form onSubmit={SubmitNew}>
                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                    <Form.Label>Start Time</Form.Label>
                                    <DateTimePicker onChange={updateTime} className={'form-control'} style={{ border: 'none' }} value={startTime} />
                                </Form.Group>
                                <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                                    <Form.Label>Duration</Form.Label>
                                    <Form.Control onChange={updateDuration} type="number" placeholder="Duration in Minutes" />
