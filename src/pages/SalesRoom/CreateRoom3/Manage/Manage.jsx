            ...
            <>
                <Container style={{ padding: '0px 150px' }}>
                    <div style={{ display: 'block', width: '100%', backgroundColor: '#ffffff' }}>
                        <h4><BiChevronLeft onClick={() => { this.props.UpdateScreen('SALESROOM') }} style={{ fontSize: '30px', marginRight: '10px', marginTop:'20px', cursor: 'pointer' }} /></h4>
                        <Row style={{margin:"10px"}}>
                            <h4>{this.props.InfoData.name}</h4>
                        </Row>
                        <Row style={{margin:"10px"}}>
                            <Col sm={7}>
                                {
                                    this.props.InfoData?.events?.map((val, key) => {
                                        ...
                                        return (<small style={{fontSize:"16px"}}>Event Date : {new Date(this.props.InfoData.fullDate).toDateString()}</small>)
                                    })
                                }
                            </Col>
                            <Col sm={5}>
