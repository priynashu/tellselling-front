...
const Info = ({Data}) => {
    ...
    const [title,
        setTitle] = useState("Sales Demo Live Streaming");
    const copy = async() => {
        await navigator
            .clipboard
            .writeText(link);
    ...
    return ( <>
     {/* <Container className={styles.container}> */}
        {/* <Row className={styles.index_row}>
            ...
            <Col sm={5} className="h-25">
                <p className={styles.date}>Sun, 5 Dec 15:30-20:30 GMT-6</p>
                <p className={styles.date}>Mon, 6 Dec 1:30-3:30 CET-6</p>
            </Col>
            <Col
                sm={{
                span: 4,
                ...
                <Form.Label className={styles.date}>Shareable Event Link</Form.Label>
                <InputGroup size="sm" className="mb-2">
                    <InputGroup.Text>@</InputGroup.Text>
                    <Form.Control size="sm" placeholder='form control' value={link} disabled/>
                    <InputGroup.Text
                        style={{
                        cursor: "pointer"
                    }}><BiCopy onClick={copy}/></InputGroup.Text>
                </InputGroup>
            </Col>
            <Col>
                <Box sx={{
                        ...
                        <Accordion defaultActiveKey="0">
                            <Accordion.Item eventKey="0">
                                <div className={styles.panel_header}>
                                    <Accordion.Header>4 Dec, 18:30 GMT-6<span className={styles.date} style={{fontWeight: "bold"}}>&nbsp;&nbsp;SATURDAY&nbsp;&nbsp;
                                    ...
                                    <Accordion.Body>
                                        <Row className="mt-2">
                                            <Col sm={6}>
                                                ...
                                                <Form.Select aria-label="Default select example" onChange={handleStreamProvider} value={streamProvider}>
                                        ...
                                        <Row>
                                            <Col sm={12}>
                                            <Button variant="custom" style={{padding:"8px 20px"}} className={styles.update_btn} ><BsCheckCircle/>&nbsp; Update</Button>
