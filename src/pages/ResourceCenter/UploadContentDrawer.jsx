...
export const UploadContentDrawer = ({ isOpen, onClose, onSuccess, filterData, allCategories, allTags, allContentAreas, allPublic_Pvt, allInternal_Ext, allInternalUses, allForms, updateTags, updateCategories, updateInternalUses, updateContentAreas, updatePublic_Pvt, updateInternal_Ext,allFormData }) => {
    ...
    const [selectedForm, setSelectedForm] = useState('no form');
    ...
    const TestSubmit = (e) => {
        ...
        if (data.categories != 0 && data.tags != 0 && data.content_areas != 0 && data.internal_uses != 0) {
            ...
            toast.warning('Must add all the filters');
        }
                ...
                <Box className={styles.drawer_wrapper}>
                    ...
                    <Box
                        ...
                        <Form.Select size='small' onChange={handleForm}>
                            <option value="no form">Not Gated Content</option>
                            {
