    ...
    GetAllForms = async () => {
        ...
        await axios.get(url)
            .then((res) => {
                ...
                const temp = [];
                console.log("all forms in index",forms);
    ...
    fetchData = async () => {
        ...
        await axios.get(backend_url + 'resources/' + user.tenantId)
            .then((res) => {
                ...
                this.setState({ filteredResources: res.data.slice(0).reverse()});
                            ...
                            return (
                                <Col key={i + "_data"} sm={3}>
                                    <DisplayCard
                                        ...
                                        allFormData = {this.state.allForms} />
                                </Col>
                            )
                        })
                        }
                        {
                           (pageContents.length==0)?<Empty/>:<></>
                        }
