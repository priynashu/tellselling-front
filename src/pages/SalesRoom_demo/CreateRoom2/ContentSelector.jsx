 ...
 */
    ...
    render() {
        // console.log("content data",this.props.info);
        if(this.state.previewBtn===true){
            let data=[]
             axios.get(`http://localhost:5000/salesroom-webinar/${this.state.link}`).then((res)=>{
        ...
        const handlePreviewClick=async()=>{
            ...
            if(this.state.previewBtn===false){
                window.open(`http://localhost:5000/salesroom-web/:${this.state.link}`,"","width=1500,height=1500")
            }
