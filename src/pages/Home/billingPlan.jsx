...
import styles from "../Billing/Billing.module.scss"
...
const BillingPlan = ({handleClose, open,setPlanType,planType,setExpiryDate,expiryDate,getHistoryData}) => {
    ...
    //    console.log("plan type",planType);
       ...
       console.log("token is",response.data.status,response.data.customerId); 
    ...
    const [features,setFeatures] = useState(['less features']);
    ...
    const fillValues = async(name)=>{
        ...
        var myPromise = new Promise(function(resolve,reject){
            setTimeout(()=>{
                ...
                {
                    setPlanType(name);
                     setCost(manualAnnual?"1.99":"1.99")
                     setProduct({ ...product, ["price"]: manualAnnual?"1.99":"1.99",["name"]:name  });
                     setFeatures(["PayPal payments","Logic Jumps","File upload with 5GB storage","Custom domain support","Stripe Intergration"])
                }
            resolve();
            ;},1000)
                    ...
                    <Card
                        ...
                        <ul>
                         ...
                         <Card.Body className="text-center">
                            <Button className={styles.currentPlanBtn} name="Basic" onClick={handleClick}>Basic</Button>
                        </Card.Body>
                    </Card>
                    <Card
                        style={{
